...
3.	**SFPGs expression**: Using the normalized FPKM for the samples and SFPG data, expression is calculated for all SFPGs.  The SFPG expression can be calculated using one of the distribution:  Equal distributioin (ED) or Group size distribution (GD)
